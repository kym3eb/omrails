...
class GarmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create garment" do
    assert_difference('Garment.count') do
      post garments_url, params: { garment: { desc: @garment.desc, name: @garment.name, type: @garment.type, user_id: @garment.user_id } }
    end
  ...
  test "should update garment" do
    patch garment_url(@garment), params: { garment: { desc: @garment.desc, name: @garment.name, type: @garment.type, user_id: @garment.user_id } }
